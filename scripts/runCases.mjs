import { generateSchedule, validateSchedule, getCoverageStartDayIndex } from '../src/logic/scheduler.js';
...
for (const params of cases) {
  ...
  try {
    ...
    const grace = getCoverageStartDayIndex(params);
    const errors = validateSchedule(schedule, params.totalDays, grace);
